 ...
 <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name_en }}</option>
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Name pg <span class="text-danger">*</span></h5>
			<div class="controls">
				<input type="text" name="product_name_pg" class="form-control" required=""  value="{{ $products->product_name_pg }}">
     @error('product_name_pg')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			<h5>Product Tags pg <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_tags_pg" class="form-control" value="{{ $products->product_tags_pg }}" data-role="tagsinput" required="">
     @error('product_tags_pg')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Size pg <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_size_pg" class="form-control" value="{{ $products->product_size_pg }}" data-role="tagsinput"  >
     @error('product_size_pg')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Product Color pg <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_color_pg" class="form-control" value="{{ $products->product_color_pg }}" data-role="tagsinput" >
     {{-- required="" --}}
     @error('product_color_pg')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 7th row  -->
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_en !!}
	     ...
	     <div class="form-group">
			<h5>Short Description Pidgin <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea name="short_descp_pg" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_pg !!}
	</textarea>
	 		 </div>
		</div>
...
<div class="row"> <!-- start 8th row  -->
	...
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">
		{!! $products->long_descp_en !!}
	     ...
	     <div class="form-group">
			<h5>Long Description Pidgin <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor2" name="long_descp_pg" rows="10" cols="80">
		{!! $products->long_descp_pg !!}
						</textarea>
	 		 </div>
		</div>
...
<div class="col-md-6">
	<div class="form-group">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_5" name="add_on" value="1" {{ $products->special_deals == 1 ? 'checked': '' }}>
				<label for="checkbox_5">Add-on's</label>
			</fieldset>
		</div>
			</div>
		</div>
