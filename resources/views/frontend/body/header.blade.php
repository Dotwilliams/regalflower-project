<header class="header-style-1">
        ...
        <div class="header-top-inner">
          <div class="cnt-account">
            <ul class="list-unstyled list-inline" >
              ...
              @else
              <li><a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>My Account</a></li>
              @endauth
            ...
            <ul class="list-unstyled list-inline">
              ...
              <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value">Language </span><b class="caret"></b></a>
                <ul class="dropdown-menu">
                  ...
                  @else
                  <li><a href="{{ route('pidgin.language') }}">Pidgin</a></li>
                  @endif
              ...
              <div class="nav-outer">
                <ul class="nav navbar-nav">
                  <li class="active dropdown yamm-fw"> <a href="{{ url('/') }}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
                      @if(session()->get('language') == 'pidgin') घर @else <i class="fa fa-home"></i> @endif
                        </a> </li>
                 ...
                 @foreach($categories as $category)
                  <li class="dropdown yamm mega-menu"> <a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
                    @if(session()->get('language') == 'pidgin') {{ $category->category_name_pg }} @else {{ $category->category_name_en }} @endif
                    </a>
  ...
  <a href="{{ url('subcategory/product/'.$subcategory->id.'/'.$subcategory->subcategory_slug_en ) }}">
                <h2 class="title">
  @if(session()->get('language') == 'pidgin') {{ $subcategory->subcategory_name_pidgin }} @else {{ $subcategory->subcategory_name_en }} @endif
                  </h2> </a>
                                ...
                                @if(session()->get('language') == 'pidgin') {{ $subsubcategory->subsubcategory_name_pg }} @else {{ $subsubcategory->subsubcategory_name_en }} @endif
                                                  </a></li>
                            ...
                            <div id="hide" class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src=" {{ asset('frontend/assets/images/banners/top-menu-banner.jpg') }} " alt=""> </div>
                            <!-- /.yamm-content -->
                          </div>
                        </div>
                      </li>
                  ...
                  <li class="dropdown"> <a href="#"><span class="menu-label hot-menu hidden-xs">trend</span>Blog</a> </li>
                  <li class="dropdown"> <a href="faq.html">FAQ's</a> </li>
                  <li class="dropdown"> <a href="contact.html">Contact</a> </li>

                  <li class="dropdown  navbar-right special-menu"> <a href="{{ url('about') }}">About Us</a> </li>
                </ul>
                <!-- /.navbar-nav -->
                <div class="clearfix"></div>
              </div>
