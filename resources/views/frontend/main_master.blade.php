...
<!-- ================================================== Chat-Bot Icon: start ===================================== -->
@include('frontend.body.chat_bot')
 <!-- ==================================================  Chat-Bot Icon: end ===================================== -->

<!-- ================================================== WhatsApp Chat Icon: start ===================================== -->
@include('frontend.body.whats_app')
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/
    latest/toastr.min.js"></script>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><strong><span style="font-size: 20px; color:red; font-weight: bold;" id="pname"></span> </strong></h5>
